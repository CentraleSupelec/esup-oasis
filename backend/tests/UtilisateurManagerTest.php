...
class UtilisateurManagerTest extends ApiTestCaseCustom
{
    ...
    {
        // ticket interne critère 2 — la projection situation sociale est alimentée par le
    ...
    {
        // ticket interne critère 2 — coeur de la règle : un code situation sociale "BO"
    ...
    {
        // ticket interne — l'adresse Apogée de la dernière inscription est projetée vers
    ...
    {
        // ticket interne : le compteur d'inscriptions à l'étape et le cursus aménagé
